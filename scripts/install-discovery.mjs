...
const backupPath = path.join(
  root,
  "components",
  "workspace.before-discovery.tsx",
);

if (!fs.existsSync(workspacePath)) {
  throw new Error(
    "components/workspace.tsx was not found. Run this script from the Bias Vault project root.",
  );
}
...
const discoverySource = String.raw`"use client";
...
console.log(
  "✓ components/discovery.tsx created",
);
...
if (
  ...
  console.log(
    "✓ Discovery sidebar item added",
  );
}

/*
 * Keep the visual nav break before Import.
 */
...
if (
  ...
  console.log(
    "✓ Discovery eyebrow added",
  );
}

/*
 * Add Discovery description.
 */

if (
  !workspace.includes(
    "Use Kpopping+ as a live reference",
  )
) {
  workspace =
    workspace.replace(
      ...
      `                            : page === "Export"
                              ? "Download clean Excel files from your current catalog."
                              : page === "Discovery"
                                ? "Use Kpopping+ as a live reference while keeping Bias Vault names and card history as your source of truth."
                                : "Manage your catalog’s rules and access."}`,
    );

  console.log(
    "✓ Discovery description added",
  );
}

/*
 * Render Discovery in the main workspace.
 */
...
if (
  ...
  console.log(
    "✓ Discovery workspace renderer added",
  );
}
...
console.log("");
console.log("==============================");
console.log("DISCOVERY INSTALL COMPLETE");
console.log("==============================");
console.log("");
console.log("Created:");
console.log(
...
console.log("Backup:");
console.log(
  "  components/workspace.before-discovery.tsx",
);
console.log("");
console.log(
  "Now run: npm run dev",
